...
import com.muti.spring.batch.conditional.flow.step.NumberInfoClassifier;
...
public class NumberInfoConfig {
    ...
    public Step numberGeneratorStep(int[] values, String prepend) {
    ...
    @Bean(name = "first_job")
    public Job numberGeneratorNonNotifierJob() {

        int[] nonNotifierData = { -1, 2, -3 };

        Step step = numberGeneratorStep(nonNotifierData, "First Dataset Processor");
